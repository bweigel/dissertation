...
\textit{apo}-\Gls{pfomt} was crystallized using the following conditions -- 2\,M \cf{(NH4)2SO4}, 20\,\%glycerol. The protein solution contained 0.25\,mM \gls{sae}, 0.25\,mM \cf{MgCl2}, 0.25\,mM eriodictyol and \SI{7.53}{\mg\per\ml} (\SI{0.262}{\milli\molar}) \gls{pfomt}.
