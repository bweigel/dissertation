...
\NormalTok{opts_chunk$}\KeywordTok{set}\NormalTok{(}\DataTypeTok{dev=}\StringTok{'pdf'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\subsection{Isorhamnetin}\label{isorhamnetin}

\includegraphics[width=0.4\textwidth]{WEB350_plotMult_files/figure-latex/isorhamtenin-1}

\includegraphics[width=0.2\textwidth]{WEB350_plotMult_files/figure-latex/unnamed-chunk-4-1}
