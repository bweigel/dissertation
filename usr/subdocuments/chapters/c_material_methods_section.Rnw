...
\Gls{omt} assays were prepared as before. 
However, the reactions were stopped by addition of 0.5 volumes catechol reagent (\mM{2} \cf{FeCl3} in \mM{10} \cf{HCl}).
...
<<test, fig.width=6.415, fig.height=2.5, echo=F>>=
