...
\begin{longtable}{p{0.35\textwidth}p{0.65\textwidth}}
  \gls{cd}-spectrometer & Jasco J-815 (Eaton, USA) \\
  ...
  \gls{fplc} & ÄKTA purifier (GE Healthcare, Freiburg, Germany) \\
  \gls{gcms} & GC-MS-QP2010 Ultra (Shimadzu, Duisburg, Germany)\\
  \gls{hplc} & VWR-Hitachi LaChrom Elite (VWR, Darmstadt, Germany) \\
  \gls{itc} & MicroCal iTC200 (Malvern, Worcestershire, UK) \\
  \gls{mtp}-reader & SpectraMax M5 (Molecular Devices, Biberach, Germany) \\
  \gls{nmr}-spectrometer & Varian Unity 400 (Agilent, Böblingen, Germany) \newline Varian VNMRS 600 (Agilent, Böblingen, Germany) \\
...
\begin{longtable}{p{0.3\textwidth}p{0.68\textwidth}}
...
\ostTableEnv[label = tab:plasmids]{%
  \begin{tabularx}{\textwidth}{p{0.3\textwidth}X}
    ...
    pQU30-PFOMT & Thomas Vogt (\gls{ipb}, Halle, Germany) \\
    \bottomrule
  \end{tabularx}
}{%
