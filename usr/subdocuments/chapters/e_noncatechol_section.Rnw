...
%% \ospSetContacts{bweigel@ipb-halle.de\textsuperscript{a}, %
%%   alaub@ipb-halle.de\textsuperscript{b}, %
%%   law@ipb-halle.de\textsuperscript{c}}
...
\begin{table}
  ...
  \begin{tabularx}{\linewidth}{XlllX}
     \toprule\small
    ...
    reosmin & cinnamic acid\footnote{homo-dihydro cinnamic ketone} & \cmark & \xmark & -- \\ 
    \bottomrule
  \end{tabularx}
\end{table}
