...
%    \includegraphics[scale=0.225, trim=0 0 0 0, clip]{usr/graphics/static/tetramer.png}
    \includegraphics[width=0.9\textwidth, trim=0 0 0 0, clip]{usr/graphics/static/tetramer.png}
    \caption{}
...
%    \includegraphics[scale=0.175, trim=0 0 0 0, clip]{usr/graphics/static/pfomt_monomer.png}
    \includegraphics[width=0.9\textwidth, trim=0 0 0 0, clip]{usr/graphics/static/pfomt_monomer.png}
    \caption{}
