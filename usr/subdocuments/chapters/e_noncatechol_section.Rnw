...
The protein concentrations measured by \textsc{Bradford}'s method were consistent with the \sdspage gels.
...
\paragraph{\Glspl{meplot}} illustrate the difference between level means for each factor.
