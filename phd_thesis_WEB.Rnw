...
\documentclass[floatbarrier=true, addfloatbarrierto=section, revision=false, linespacing=onehalfspacing, fontchoice=libertine, colortheme=orange, oneside]{ost/subdocuments/open_science_thesis} 
...
%%%-------------------------------------------------%%%
%%% Include MT whole cell screening section %%%
%%%-------------------------------------------------%%%
