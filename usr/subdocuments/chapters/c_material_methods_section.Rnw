...
Primers used in this work. Recognition sites for endonucleases are underlined. Positions used for mutagenesis are in lower case font.
}
...
\subsection{Subcloning of \textit{pfomt}}
...
First an endogenous NdeI site was removed by site directed mutagenesis using primers \emph{pfomt1.fw} and \emph{pfomt1.rv}.
The \textit{pfomt} gene was then amplified using oligonucleotides \emph{pfomt2.fw} and \emph{pfomt2.rv} and cloned into pET-28 employing the NdeI and EcoRI cloning sites. 

\subsection{Subcloning og \textit{somt-2}}
