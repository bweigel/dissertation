...
Before infiltration \nico plants were pruned, such that only leaves to be infiltrated remained with the plant.
...
The supernatant was centrifuged again (\timesg{20000}, \degC{4}, 10\,min) and the resulting supernatant was transferred to a \gls{hplc}-vial and stored at \degC{-20} until analysis.
