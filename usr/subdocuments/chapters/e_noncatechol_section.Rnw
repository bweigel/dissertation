...
Each substrate was assessed for conversion with two enzymes (\pfomt wild-type and 4'-specific variant \pfomt Y51R N202W) at four different conditions.
Magnesium addition and pH for the different conditions (pH/\cf{Mg^2+}: low/no, low/yes, high/no, high/yes).
...
\begin{table}[htb]\centering\small
  ...
  \begin{tabular}{lrrccc}
    ...
    myricetin &  flavonole & 3',4',5'-trihydroxy & OH & OH  &  OH \\
    \bottomrule
  \end{tabular}
\end{table}
%
The \gls{meplot} and \gls{iaplot} suggest the same, however there is no statistical evidence to support this notion (see \autoref{fig:x_mep_pfomt}, \ref{fig:x_iap_pfomt} \bweigel{evtö hier noch ne tabelle von modelcoefficiebnts?}).
...
\begin{table}[htb]\centering\small
  ...
  \begin{tabular}{lcccccc}
    \toprule
    \multirow{2}{*}{substrate} & \multicolumn{3}{>{\centering}p{0.3\textwidth}}{wild-type} & \multicolumn{3}{>{\centering}p{0.3\textwidth}}{4'-specific variant} \\
    \cmidrule(lr){2-4}\cmidrule(lr){5-7}
    & conversion & pH & \cf{Mg^2+} & conversion & pH & \cf{Mg^2+}  \\
    & \% & & & \% & & \\
    \midrule
    naringenin & 6  & \textglobrise  & \cmark  &   &   &   \\
    eriodictyol\textsuperscript{\textdagger} & 94  &  \multicolumn{2}{c}{(all)}  & 92  & \textglobrise  & \cmark  \\
    hesperetin &  22 & \textglobfall  & \cmark  &   &   &   \\
    homoeriodictyol & 6  & \textglobrise  & \cmark  & 4  & \textglobrise  & \cmark  \\
    \midrule
    apigenin & 5  & \textglobrise  & \cmark  &   &   &   \\ 
    luteolin\textsuperscript{\textdagger} &  95  & \multicolumn{2}{c}{(all)}  & 92  & \textglobrise  &   \\ 
    ...
    caffeic acid\textsuperscript{\textdagger} & 100\textsuperscript{\textdaggerdbl}  & \multicolumn{2}{c}{(all)} & 93  &  \multicolumn{2}{c}{(all)} \\
    ...
    \bottomrule
    \multicolumn{7}{p{0.9\textwidth}}{\footnotesize \textsuperscript{\textdagger}wild-type: substrate conversion was maximal for all pH/\cf{Mg^2+} combinations. \newline \textsuperscript{\textdaggerdbl}conversion of caffeic acid by the wild-type was set to 100\,\%.}
  \end{tabular}
\end{table}
