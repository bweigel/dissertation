...
The tested substrates were selected from four different compound groups (cinnamic acids, flavones, flavanones and flavonols) and each group contained each of the structural motifs tested (phenol, catechol, \glsentryfirst{3o4m}, \glsentryfirst{4o3m}), if possible.
Each substrate was assessed for conversion with two enzymes (\pfomt wild-type and 4'-specific variant \pfomt Y51R N202W) at four different conditions (pH/\cf{Mg^2+}: low/no, low/yes, high/no, high/yes).
...
There was almost complete conversion of the catecholic substrates (eriodictyol, luteolin, caffeic acid and quercetin) under all condition after 16\,h of incubation, at least when the wild-type enzyme was used (\autoref{tab:pfomtconversion}).
