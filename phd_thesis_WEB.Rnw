...
\documentclass[autolayout=false, addfloatbarrierto=section, revision=false, linenumbers=true, linespacing=onehalfspacing, fontchoice=libertine, colortheme=orange, oneside, titlepagetheme=mlu]{ost/subdocuments/open_science_thesis} 
...
\begin{document}
\newgeometry{right=6cm, scale=0.6, vmargin=1.5cm, includeheadfoot}
