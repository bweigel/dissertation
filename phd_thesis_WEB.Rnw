...
\documentclass[floatbarrier=true, addfloatbarrierto=section, revision=false, linenumbers=true, linespacing=onehalfspacing, fontchoice=libertine, colortheme=orange, oneside]{ost/subdocuments/open_science_thesis} 
