...
However, the shown results are solely included for purposes of making statistics based inferences.
...
\subsection{Methylation of (3'-hydroxy-4-\textit{O}-methyl)-moieties}

\section{Structural studies of flavonoids using \glsentryfirst{msms}}\bweigel{extra kapitel?}
