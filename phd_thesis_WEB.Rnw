...
\documentclass[autolayout=false, addfloatbarrierto=section, revision=false, linenumbers=false, linespacing=onehalfspacing, fontchoice=libertine, colortheme=orange, twoside, titlepagetheme=mlu, natbib=true, style=chem-acs]{ost/subdocuments/open_science_thesis} 
