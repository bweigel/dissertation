...
Thus, natural products containing longer chain alkyl modifications like ethyl or propyl moieties on O, N or S-centers have rarely, if ever been observed. \bweigel{cite something}
...
The first description of novel synthetic \gls{sam} analogues, including \gls{sae}, allyl and propargyl derivatives, that were also shown to be useful in modifying \gls{dna} via the action of several \glspl{dmt} was provided by Dalhoff, \etal \cite{Dalhoff2006,Dalhoff2006a}. \\
...
\begin{lstTabularx}[1]{\linewidth}{>{\scriptsize}p{0.45\textwidth}XX>{\scriptsize}p{0.12\textwidth}}
  \caption{\gls{sam} analogues that have been used with \glspl{mt}. Targets: \emph{P} -- protein, \emph{D} -- DNA, \emph{R} -- RNA, \emph{S} -- small molecule.} \\
  \label{tab:mtlit}
  \hfill \\
     \toprule
	...
	\small analogue & enzyme & target & \small references \\ 
     ...
     \small\textit{SAM} & & &\\
    % \cf{-CH3} & & &\\
     \cf{-CH2-CH3} & & S & \citep{Wang2014,Thomsen2013,Dalhoff2006,Singh2014,Law2015} \footnote{Singh \etal (2014) published a series of 44 biocatalytically synthesized \gls{sam} and \gls{seam} derivatives, most of which were not tested towards their alkyl donation potential in \gls{mt} reactions.}\\
     \cf{-CH2-CH2-CH3} & & & \citep{Thomsen2013,Dalhoff2006}\\
     \cf{-CH2-CH2-CH2-CH3} & & & \citep{Thomsen2013}\\
     \cf{-CH2-C6H5} & NovO, CouO & S & \citep{Stecher2009,Thomsen2013}\\
     \cf{-CH2-CH2-C6H5} & & & \citep{Thomsen2013}\\
     \cf{-CH2-CH(-NH2)-COOH} & & & \citep{Thomsen2013}\\
     \cf{-CH2-C(=O)-NH2} & & & \citep{Thomsen2013}\\
     \cf{-CH2-C(=O)-CH3} & COMT, TPMT & S & \citep{Lee2010}\\
     
     \cf{-CH2-CH=CH2} & NovO, CouO, RapM & P,S & \citep{Wang2014,Stecher2009,Thomsen2013,Dalhoff2006,Singh2014,Wang2011,Wang2011a,Tengg2012a,Law2015} \\
     \cf{-CH2-CH=CH-CH3} & NovO, CouO & S & \citep{Wang2014,Stecher2009}\\
     \cf{-CH2-CH=CH-CH2-CH3} & & & \citep{Wang2014}\\
    
     \cf{-CH2-C#CH} & Dim-5, \textit{Hs}MLL, TRM1, NovO, CouO & P,R,S & \citep{Willnow2012,Stecher2009,Thomsen2013,Wang2011,Wang2011a,Islam2011}\\
     \cf{-CH2-C#N} & & S & \citep{Singh2014} \\
     \cf{-CH2-CH2-C#CH} & PKMT & P & \citep{Islam2011}\\
     \cf{-CH2-CH2-CH2-C#CH} & PKMT & P & \citep{Islam2011}\\
     \cf{-CH2-C#C-CH3} & NovO, CouO & S & \citep{Stecher2009,Dalhoff2006,Lukinavicius2013}\\
     \cf{-CH2-C#C-CH2-CH3} & & & \citep{Lukinavicius2013} \\
     \cf{-CH2-C#C-CH2-NH2} & & & \citep{Lukinavicius2013} \\
     \cf{-CH2-C#C-CH2-NH-C(=O)(-CH2-)3-NH2} & & & \citep{Lukinavicius2013} \\
     \cf{-CH2-C#C(-CH2-)3-NH2} & & & \citep{Lukinavicius2013} \\
     \cf{-CH2-C#C(-CH2-)3-NH-C(=O)(-CH2-)3-NH2} & & & \citep{Lukinavicius2013} \\
     \cf{-CH2-C#C(-CH2-)3-C#CH} & & & \citep{Lukinavicius2013} \\
     \cf{-CH2-C#C(-CH2-)3-N3} & & & \citep{Lukinavicius2013} \\
     \cf{-CH2-CH=CH-C#CH} & Dim-5, \textit{Hs}MLL, TRM1 & P,R & \citep{Willnow2012,Peters2010,Wang2014,Wang2011,Wang2011a,Motorin2011,Islam2011}\\
     \cf{-CH2-CH=CH-CH2-C#CH} & & & \citep{Wang2014,Wang2011a,Islam2011} \\
     \cf{-CH2-CH=CH-CH2-O-CH2-C#CH} & & P & \citep{Wang2014,Wang2011,Wang2011a}\\
     
    \\
     \small\textit{SeAM} & & &\\
     \cf{-CH3} & & & \\
     \cf{-CH2-C#CH} & Dim-5, \textit{Hs}MLL, TRM1 & P,R & \citep{Willnow2012,Singh2014,Bothwell2012}\\
