...
The \meplot for protein concentration shows, that arginine seems to be an important factor for the refolding of \somt (\autoref{fig:MEplot}).
...
The activity of the samples did not correlate well with the amount soluble protein.
...
\begin{figure}[htpb]
  ...
  \begin{figureframe}
    \begin{subfigure}{\textwidth}\centering
      \includegraphics[width=0.75\textwidth]{usr/graphics/static/tmp_refold_hplc}
